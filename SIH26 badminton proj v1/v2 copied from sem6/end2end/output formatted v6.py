...
def print_dashboard(summary, comparison, gap_analysis,
                    level, consistency_scores, stability_score,
                    fatigue, player_profile, suggestions, df):
    ...
    print(f"Weak / Med / Strong : {summary['weak_count']} / {summary['medium_count']} / {summary['strong_count']}")
    ...
    print(f"Speed:{b['speed']:.2f}  Impact:{b['impact']:.2f}  Power:{b['power']:.2f}")

    print("\n❄ WORST SWING")
    w = summary["worst_swing"]
    print(f"Speed:{w['speed']:.2f}  Impact:{w['impact']:.2f}  Power:{w['power']:.2f}")
    ...
    print(f"Consistency: {consistency_scores['consistency_score']}/100")
